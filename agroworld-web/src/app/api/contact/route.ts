...
export async function POST(req: NextRequest) {
  ...
  const messageBlock = message
    ? `<div style="margin-top:16px;"><p style="color:#666;margin-bottom:8px;">Message :</p><div style="background:#f9f9f9;border-left:3px solid #2a9d8f;padding:12px 16px;border-radius:4px;color:#333;">${messageHtml}</div></div>`
    : "";
